...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email into the email input (index 7), then type the provided password into the password input (index 8), then click the 'Sign in' button (index 11).
