...
async def run_test():
    ...
    try:
        ...
        # -> Type the provided email and password into the form and click the 'Sign in' button.
        ...
        # -> Click the 'Drift' navigation item (index 338) to open the Drift Timeline page.
        frame = context.pages[-1]
        # Click element
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=No themes').first).to_be_visible(timeout=3000)
        await expect(frame.locator('text=No analyzed entries').first).to_be_visible(timeout=3000)
