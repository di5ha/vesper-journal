...
async def run_test():
    ...
    try:
        ...
        # -> Type the email into the email field (index 7) and the password into the password field (index 8), then click the Sign in button (index 11).
        ...
        # -> Click the Sign out button (index 260) to sign the user out and then verify the app redirects back to /auth.
        frame = context.pages[-1]
        # Click element
        ...
        raise Exception("Sign out button not found in the available elements; cannot perform Sign out and verify redirect to /auth. Task marked as done.")
