...
async def run_test():
    ...
    try:
        ...
        # -> Type the email into the email field and then the password, then click 'Sign in'.
        ...
        # -> Click the 'Drift' navigation item to load the Drift page (to observe skeleton then chart).
        frame = context.pages[-1]
        # Click element
