...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email (index 7) and password (index 8) fields with provided credentials, then click the 'Sign in' button (index 11).
        ...
        # -> Click the 'Drift' nav link in the sidebar (index 338) to navigate to the Drift timeline.
        frame = context.pages[-1]
        # Click element
