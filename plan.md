...
- [x] `GET /dashboard/stats` — streak, 7-day sparkline, latest analysis
  - **File:** `backend/app/api/dashboard.py`
- [x] Streak counter (flame icon, colour scales by streak length)
  - **File:** `frontend/src/components/StreakCounter.jsx`
- [x] 7-day mood sparkline (recharts, no axes/grid, mini tooltip)
  - **File:** `frontend/src/components/MoodSparkline.jsx`
- [x] Quick access links: New Entry, Drift Timeline, Generate Report
  - **File:** `frontend/src/components/QuickLinks.jsx`
- [x] Dashboard stats bar integrated above editor
  - **File:** `frontend/src/pages/Dashboard.jsx`
- [x] Stats refresh on every entry save (via `refreshTick`)
